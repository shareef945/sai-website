const projects = [
  {
    index: 1, // Added an index for each project
    title: "Swift Transport MVP",
    imageSrc:
      "https://files.saitechnology.co/api/public/dl/VtGlBzmd?inline=true",
    ...
    "Short Description":
      "Swift Transport is a seamless marketplace connecting travelers and bus operators across Ghana. Our platform offers easy ticket booking, real-time updates, and expanded accessibility through local agents, making travel simpler, faster, and more reliable for everyone",
    "Landing Media Url":
      "https://files.saitechnology.co/api/public/dl/VtGlBzmd?inline=true",
    "Solution 2":
    ...
    "Feature 3 Thumbnail":
      "https://files.saitechnology.co/api/public/dl/LxQi7zdI?inline=true",
    Testimonial:
      "SAI Technology has been instrumental in helping Swift Transport enhance our platform with scalable and efficient solutions. Their expertise, professionalism, and innovative approach have significantly improved our operations and customer experience. We highly recommend them as a trusted technology partner.",
    "Feature 1": "Real-Time Seat Availability & Booking",
    Owner: ["Shareef Ali"],
    Services: ["API Development", "Web App Design", "Web App Development"],
    Status: "Done",
    "Challenge 2":
    ...
    Deals: ["f4fafdf4-d0bf-40a5-a595-a3b936d15a0d"],
    Priority: "High",
    "Feature 1 Thumbnail":
      "https://files.saitechnology.co/api/public/dl/MNRTHZ0J?inline=true",
    "Feature 2 Thumbnail":
      "https://files.saitechnology.co/api/public/dl/ah0ccCPv?inline=true",
    "Solution 3":
    ...
    "Feature 5 Thumbnail":
      "https://files.saitechnology.co/api/public/dl/QJmcx3iP?inline=true",
    "Challenge 1":
      "Fragmented Bus Ticketing System: \nMany bus companies operate independently, resulting in limited integration and coordination across services. This fragmentation makes it difficult for travelers to compare prices, schedules, and availability.",
    "Grid Media Urls":
      "https://files.saitechnology.co/api/public/dl/p_5B4CE1?inline=true , https://files.saitechnology.co/api/public/dl/5WSKRypB?inline=true , https://files.saitechnology.co/api/public/dl/TgaBibwM?inline=true , https://files.saitechnology.co/api/public/dl/zcoejvFD?inline=true",
    "Solution 1":
    ...
    "Long Description":
      "Swift Transport revolutionizes the way you travel across Ghana. By connecting multiple bus operators into one platform, we make it simple to find, compare, and book your tickets in seconds. Whether you're traveling for business, leisure, or need to book last-minute, our platform offers real-time updates to keep you informed. Plus, our growing network of local agents ensures that ticket access is available even in the most remote areas, making travel more accessible to all.",
    "Result 2": "40% reduction in customer complaints",
    Documents: [],
    "Testimonial Name": "Emmanuel Ede",
    "Feature 3": "Payment Integration & Payouts",
    "Feature 4 Thumbnail":
      "https://files.saitechnology.co/api/public/dl/2frBPt20?inline=true",
