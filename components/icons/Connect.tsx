  ...
  return (
    ...
    >
      <g fill="none" strokeWidth={1.5}>
        <path stroke="#EA5C1C" strokeLinecap="round" d="M16.5 7.5h-3"></path>
        <path
          stroke="#808080"
        ...
        ></path>
        <path stroke="#808080" strokeLinecap="round" d="M22 20h-8M2 20h8m2-2v-3"></path>
        <circle cx={12} cy={20} r={2} stroke="#808080"></circle>
      </g>
    </svg>
  );
}