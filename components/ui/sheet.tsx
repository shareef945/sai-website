...
>(({ side = "right", className, children, ...props }, ref) => (
  ...
  disabled:pointer-events-none data-[state=open]:bg-white dark:ring-offset-neutral-950 
  dark:focus:ring-neutral-300 dark:data-[state=open]:bg-white text-white fill-white stroke-white"
      >
        <X className="h-6 w-6" />
