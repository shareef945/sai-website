...
export default function ProjectTestimonial({ project }: ProjectProps) {
  return (
    <div className="w-full text-white ">
      <div className="container mx-auto md:px-[435px] py-16 md:py-24 ">
        <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center">Testimonial</h2>

        <div className="max-w-3xl mx-auto text-center">
          <blockquote className="text-lg md:text-xl italic text-center text-neutral-400 mb-8">{project.testimonial}</blockquote>
