      ...
      <section className="space-y-8 md:space-y-12">
        <div>
          ...
          <p className="text-[#898989] mb-4 md:mb-6">
            SAI Technology is committed to ensuring the security and privacy of
            client data. While we do not directly store or manage data, we
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-[#898989] mb-4 md:mb-6 space-y-2">
            ...
            <li>
              Security and confidentiality – We enforce strict security controls
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-[#898989] mb-4 md:mb-6 space-y-2">
            ...
            <li>
              ...
              (MFA) are enforced where applicable.
            </li>
        ...
        <div>
          ...
          <ul className="list-disc list-inside text-[#898989] mb-4 md:mb-6 space-y-2">
            ...
            <li>
              Regular code security reviews and automated vulnerability scanning
              are performed.
            </li>
        ...
        <div>
          ...
          <p className="text-[#898989] mb-4 md:mb-6">
            Data collected within applications we build is handled in accordance
            with client requirements and applicable laws. We provide guidance on
            data retention policies to clients. Secure deletion methods are
