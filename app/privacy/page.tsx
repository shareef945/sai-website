const PrivacyPolicy = () => {
    return (
      <div className="max-w-[57rem] w-auto mx-auto text-white py-8 md:py-16 px-4 md:px-3">
        ...
        <section className="space-y-8 md:space-y-12">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">2. Scope</h2>
            <p className="text-gray-400 mb-4 md:mb-6">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">3. Data Protection Principles</h2>
            <p className="text-gray-400 mb-4 md:mb-6">
              SAI Technology aligns with the following principles:
            </p>
            <ul className="list-disc list-inside text-gray-400 mb-4 md:mb-6 space-y-2">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">4. Access Control & Authentication</h2>
            <ul className="list-disc list-inside text-gray-400 mb-4 md:mb-6 space-y-2">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">5. Data Encryption & Protection</h2>
            <ul className="list-disc list-inside text-gray-400 mb-4 md:mb-6 space-y-2">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">6. Logging & Monitoring</h2>
            <ul className="list-disc list-inside text-gray-400 mb-4 md:mb-6 space-y-2">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">7. Software Development Security</h2>
            <ul className="list-disc list-inside text-gray-400 mb-4 md:mb-6 space-y-2">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">8. Data Processing & Retention</h2>
            <p className="text-gray-400 mb-4 md:mb-6">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">9. Incident Response & Reporting</h2>
            <p className="text-gray-400 mb-4 md:mb-6">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">10. Compliance & Internal Audits</h2>
            <ul className="list-disc list-inside text-gray-400 mb-4 md:mb-6 space-y-2">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">11. Vendor & Third-Party Risk Management</h2>
            <p className="text-gray-400 mb-4 md:mb-6">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">12. Conclusion</h2>
            <p className="text-gray-400 mb-4 md:mb-6">
