...
const GDPRSection = () => {
  return (
    ...
    <GridBackground size="sm"/>
      <div className="w-full z-20 relative max-w-[57rem] mx-auto text-white py-16 px-6 md:px-20">
        {/* GDPR Title */}
        ...
        <section className="mb-16">
          ...
          <p className="text-[#898989] mb-6">
            SAI Technology is committed to meeting the highest standards for
            data security and privacy. Below are the certifications that reflect
            our commitment:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#191919] p-8 rounded-lg border border-[#ffffff0a] flex flex-col items-center text-center">
              ...
              <p className="text-[#898989] text-sm mt-2 max-w-lg">
                We adhere to Ghana&#39;s Data Protection Act, ensuring the
